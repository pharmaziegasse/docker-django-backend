...
class _S_IndividualBlock(blocks.StructBlock):
    ...
    individual_footer = blocks.CharBlock(null=True, blank=True, classname="full title", help_text="Footer text")
...
class _S_ExpertsBlock(blocks.StructBlock):
    ...
    experts_footer = blocks.CharBlock(null=True, blank=True, classname="full title", help_text="Footer text")
